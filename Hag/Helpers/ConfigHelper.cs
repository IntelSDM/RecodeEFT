...
namespace Hag.Helpers
{
    class ConfigHelper
    {
        ...
        private static string ConfigPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "EftHag\\");
        ...
        private static string DecryptStatic(string cipherText)
        {
        ...
        private static string EncryptStatic(string clearText)
        {
